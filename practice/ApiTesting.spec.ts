...
let tokenValue:any
test.beforeAll("AUTH", async ({ request }) => {
...
test("AUTH 3", async ({ request }) => {
    const resp1 = await request.delete("https://restful-booker.herokuapp.com/booking/1",{
        headers:{
            Cookie:"token="+tokenValue,
        }
    })
